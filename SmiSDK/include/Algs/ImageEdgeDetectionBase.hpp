...
#ifndef _PGImageEdgeDetectionBase_HPP_
#define _PGImageEdgeDetectionBase_HPP_
//////////////////////////////////////////////////////////////////////////


#include "ImageEdgeDetectionBase.h"
...
namespace PGAlgs
{
	...
	bool ImageEdgeDetectionBase<T, U>::Execute() {
		...
		bool rv = detectEdgeCanny(m_sigma, 0.2, 0.9, inImage, m_oImageObject);	
	...
	template <class T, class U>
	bool ImageEdgeDetectionBase<T, U>::detectEdgeCanny(float iSigma, /* Standard deviation of the gaussian kernel. */
		...
		)
	{
		...
		****************************************************************************/
		...
		PGAlgs::DumpImageAsPGM(*iInImage, std::string("C:\\Data\\OriginalImage.pgm"));
		...
		****************************************************************************/
		...
		PGCore::GaussianKernel<double, T> gausskernel(iSigma, 3);
		gausskernel.Convolve(*iInImage, smoothedImage);
		smoothedim = (T *)smoothedImage.GetBuffer();

		PGAlgs::DumpImageAsPGM(smoothedImage, std::string("C:\\Data\\SmoothImage.pgm"));
		...
		****************************************************************************/
		...
		PGCore::DerivativeOfGaussianKernel<double, T> derivOfGaussian(iSigma);		
...
#ifdef _DEBUG
			PGAlgs::DumpImageAsPGM(oImageDerivGX, std::string("C:\\Data\\GradientX.pgm"));
#endif
		}
		// Y gradient
		if (1)
...
#ifdef _DEBUG
			PGAlgs::DumpImageAsPGM(oImageDerivGY, std::string("C:\\Data\\GradientY.pgm"));
#endif
		}
...
#ifdef _DEBUG
		PGAlgs::DumpImageAsPGM(gradientMagntudeImage, std::string("C:\\Data\\GradientMagnitude.pgm"));
#endif
		...
		****************************************************************************/
		...
		if (!rv) 
			return false;
#ifdef _DEBUG
		PGAlgs::DumpImageAsPGM(nonMaxSuppressedImage, std::string("C:\\Data\\NonMaxSuppressed.pgm"));
#endif
...
#ifdef _DEBUG
		PGAlgs::DumpImageAsPGM(*oEdgeImage, std::string("C:\\Data\\Edges.pgm"));
#endif
		/****************************************************************************
...
//////////////////////////////////////////////////////////////////////////
// EOF
#endif	// _PGImageEdgeDetectionBase_HPP_
