...
#if !defined(AFX_IODef3D_H__C4EA1B91_0881_44C7_927E_3CD2769137C9HPP__INCLUDED_)
#define AFX_IODef3D_H__C4EA1B91_0881_44C7_927E_3CD2769137C9HPP__INCLUDED_
...
template <class T>
bool IODef3D<T>::Write(PGCore::BaseDataObject *iDataObject, const IOParams &iParams,
...
template <class T>
bool IODef3D<T>::Read(PGCore::BaseDataObject *oDataObject, const IOParams &iParams,
...
template <class T>
bool IODef3D<T>::ParseDefinitionFile(const std::string &iDefSourceName, std::vector<std::string>& ioFileNames, 
...
// protected
template <class T>
bool IODef3D<T>::WriteToFolder(const std::vector<std::string>& iFileList,	PGCore::BaseDataObject *iMetaDataObject,
...
template <class T>
bool IODef3D<T>::ReadFromFolderMT_PPM(const std::vector<std::string>& iFileList)//,	PGCore::BaseDataObject *iMetaDataObject,
		//PGCore::Volume<T> *oDataObject)
{
...
template <class T>
bool IODef3D<T>::ReadFromFolderMT_PGM(const std::vector<std::string>& iFileList)//,	PGCore::BaseDataObject *iMetaDataObject,
		//PGCore::Volume<T> *oDataObject)
{
	LOG0("{ ReadFromFolderMT");
...
template <class T>
bool IODef3D<T>::ReadFromFolderPGM(const std::vector<std::string>& iFileList,	PGCore::BaseDataObject *iMetaDataObject,
		PGCore::Volume<T> *oDataObject)
{
...
template <class T>
bool IODef3D<T>::ReadFromFolderPPM(const std::vector<std::string>& iFileList,	PGCore::BaseDataObject *iMetaDataObject,
		PGCore::Volume<T> *oDataObject)
{
	if (!iMetaDataObject || !oDataObject || iFileList.size()<1)
	{
...
template <class T>
bool IODef3D<T>::RearrangeSlices(const std::vector<SlicePosition>& iSortedPositions, std::vector<PGCore::Image<T> >& iVolume,
...
template <class T>
void IODef3D<T>::StartExecution_PGM(void *iParam)
{
...
template <class T>
void IODef3D<T>::StartExecution_PPM(void *iParam)
{
...
template <class T>
void IODef3D<T>::StartExecution(void *iParam)
{
	switch (m_fileFormat)
	{
	case kPgIOSourceFormatPGM:	
...
#endif // !defined(AFX_IODef3D_H__C4EA1B91_0881_44C7_927E_3CD2769137C9HPP__INCLUDED_)
