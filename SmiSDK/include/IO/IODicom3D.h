...
#if !defined(AFX_IODicom3D_H__C4EA1B91_0881_44C7_927E_3CD2769137C9__INCLUDED_)
#define AFX_IODicom3D_H__C4EA1B91_0881_44C7_927E_3CD2769137C9__INCLUDED_
...
template <class T>
class IODicom3D : public IOBase<T>, public PGCore::ThreadedProcess
{
public:
	IODicom3D(void);
...
private:
	...
	bool ReadFromFile(const std::string& iFile,	PGCore::BaseDataObject *iMetaDataObject,
		PGCore::Volume<T> *oDataObject);	
	bool WriteToFolder(const std::vector<std::string>& oFileList,	PGCore::BaseDataObject *iMetaDataObject,
		PGCore::Volume<T> *oDataObject);	
	bool WriteToFile(const std::string& iFile,	PGCore::BaseDataObject *iMetaDataObject,
		PGCore::Volume<T> *oDataObject);	
	...
	#include "IO/IODicom3D.hpp"
#endif


#endif // !defined(AFX_IODicom3D_H__C4EA1B91_0881_44C7_927E_3CD2769137C9__INCLUDED_)
