...
#if !defined(AFX_IOPgm3D_H__C4EA1B91_0881_44C7_927E_3CD2769137C9HPP__INCLUDED_)
#define AFX_IOPgm3D_H__C4EA1B91_0881_44C7_927E_3CD2769137C9HPP__INCLUDED_
...
void IOPgm3D<T>::StartExecution(void *iParam)
{
		...
		: PGIO::kPgIOSourceTypeFolder;		
	{
		...
		PGIO::IOPgm3D<short> pPgmImgIO3D;
		PGIO::IOParams ioParamsPgm(
			iFileNames,
			std::string(""),
			srcType);
		...
		// set smoothing flag
		pPgmImgIO3D.SetSmoothFlag(iParams->smoothWhenSkipping);
...
#endif // !defined(AFX_IOPgm3D_H__C4EA1B91_0881_44C7_927E_3CD2769137C9HPP__INCLUDED_)
