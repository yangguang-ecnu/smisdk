...
<VisualStudioProject
	...
	Version="8.00"
	Name="pdf2dcm"
	ProjectGUID="{53F6BD21-2E91-4CAC-BEC9-39C2C3CA1CC2}"
	SccProjectName=""
	SccLocalPath=""
	Keyword="Win32Proj">
	<Platforms>
	...
	<Configurations>
		<Configuration
			...
			IntermediateDirectory="pdf2dcm.dir\Debug"
			ConfigurationType="1"
			UseOfMFC="0"
...
/>
		...
		<Configuration
			...
			IntermediateDirectory="pdf2dcm.dir\Release"
			ConfigurationType="1"
			UseOfMFC="0"
			ATLMinimizesCRunTimeLibraryUsage="FALSE"
			CharacterSet="2">
...
/>
			...
			<Tool
				...
				AdditionalDependencies="$(NOINHERIT) kernel32.lib user32.lib gdi32.lib winspool.lib shell32.lib ole32.lib oleaut32.lib uuid.lib comdlg32.lib advapi32.lib  netapi32.lib wsock32.lib ofstd.lib dcmdata.lib "
				OutputFile="Release\pdf2dcm.exe"
				Version="0.0"
				GenerateManifest="TRUE"
				LinkIncremental="1"
				AdditionalLibraryDirectories="..\$(OutDir),..,..\..\ofstd\$(OutDir),..\..\ofstd,..\..\ofstd\libsrc\$(OutDir),..\..\ofstd\libsrc,..\libsrc\$(OutDir),..\libsrc"
		...
		<Configuration
			...
			IntermediateDirectory="pdf2dcm.dir\MinSizeRel"
			ConfigurationType="1"
			UseOfMFC="0"
			ATLMinimizesCRunTimeLibraryUsage="FALSE"
			CharacterSet="2">
...
/>
			...
			<Tool
				...
				AdditionalOptions="   /STACK:10000000 /machine:I386 "
				AdditionalDependencies="$(NOINHERIT) kernel32.lib user32.lib gdi32.lib winspool.lib shell32.lib ole32.lib oleaut32.lib uuid.lib comdlg32.lib advapi32.lib  netapi32.lib wsock32.lib ofstd.lib dcmdata.lib "
				OutputFile="MinSizeRel\pdf2dcm.exe"
				Version="0.0"
				GenerateManifest="TRUE"
				LinkIncremental="1"
				AdditionalLibraryDirectories="..\$(OutDir),..,..\..\ofstd\$(OutDir),..\..\ofstd,..\..\ofstd\libsrc\$(OutDir),..\..\ofstd\libsrc,..\libsrc\$(OutDir),..\libsrc"
		...
		<Configuration
			...
			IntermediateDirectory="pdf2dcm.dir\RelWithDebInfo"
			ConfigurationType="1"
			UseOfMFC="0"
			ATLMinimizesCRunTimeLibraryUsage="FALSE"
			CharacterSet="2">
...
/>
			...
			<Tool
				...
				AdditionalOptions="   /STACK:10000000 /machine:I386 /debug "
				AdditionalDependencies="$(NOINHERIT) kernel32.lib user32.lib gdi32.lib winspool.lib shell32.lib ole32.lib oleaut32.lib uuid.lib comdlg32.lib advapi32.lib  netapi32.lib wsock32.lib ofstd.lib dcmdata.lib "
				OutputFile="RelWithDebInfo\pdf2dcm.exe"
				Version="0.0"
				GenerateManifest="TRUE"
				LinkIncremental="2"
				AdditionalLibraryDirectories="..\$(OutDir),..,..\..\ofstd\$(OutDir),..\..\ofstd,..\..\ofstd\libsrc\$(OutDir),..\..\ofstd\libsrc,..\libsrc\$(OutDir),..\libsrc"
