...

{
	...
	if (iParams->iFileNames==NULL || iParams->ioVolume==NULL || iParams->ioAttributes==NULL)
	{
		...
		{
			IOPpm3D<T>* iParentThreadPtr = (IOPpm3D<T> *)(iParams->iParentThreadPtr);
	...
	template class IOPpm3D<short>; 
	template class IOPpm3D<unsigned char>; 	
#endif
